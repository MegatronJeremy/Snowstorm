...
namespace Snowstorm {
	...
	{
		SS_CORE_WARN_TAG("Renderer", "VulkanSwapChain::OnDestroy");
	...
	{
		SS_CORE_WARN_TAG("Renderer", "VulkanSwapChain::OnResize");
	...
	{
		SS_SCOPE_PERF("VulkanSwapChain::BeginFrame");
	...
	{
		SS_PROFILE_FUNC();
		SS_SCOPE_PERF("VulkanSwapChain::Present");
		...
		VkResult result;
		{
			SS_SCOPE_PERF("VulkanSwapChain::Present - QueuePresent");
		...
		{
			SS_PROFILE_SCOPE("VulkanSwapChain::Present - WaitForFences");
