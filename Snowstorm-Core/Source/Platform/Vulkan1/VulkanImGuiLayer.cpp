...
#include "imgui.h"
#include "Snowstorm/ImGui/ImGuizmo.h"
#include "Snowstorm/ImGui/ImGuiFonts.h"
...
#include "Snowstorm/Editor/FontAwesome.h"
...
namespace Snowstorm {
	...
	void VulkanImGuiLayer::OnAttach()
	{
		...
		// Configure Fonts
		{
			...
			static const ImWchar s_FontAwesomeRanges[] = { SS_ICON_MIN, SS_ICON_MAX, 0 };
