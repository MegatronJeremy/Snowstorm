...
#include "Snowstorm/Core/RenderThread.h"
...
namespace Snowstorm {
	...
	namespace Utils {
		...
		inline void DumpGPUInfo()
		{
			...
			SS_CORE_TRACE_TAG("Renderer", "GPU Info:");
			SS_CORE_TRACE_TAG("Renderer", "  Vendor: {0}", caps.Vendor);
			SS_CORE_TRACE_TAG("Renderer", "  Device: {0}", caps.Device);
			SS_CORE_TRACE_TAG("Renderer", "  Version: {0}", caps.Version);
		}
