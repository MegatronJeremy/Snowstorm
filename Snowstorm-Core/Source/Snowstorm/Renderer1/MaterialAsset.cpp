...
namespace Snowstorm {
		...
		: m_Transparent(transparent)
	{
		...
		if (transparent)
			m_Material = Material::Create(Renderer::GetShaderLibrary()->Get("SnowstormPBR_Transparent"));
		else
			m_Material = Material::Create(Renderer::GetShaderLibrary()->Get("SnowstormPBR_Static"));
	...
	{
		SS_CORE_ASSERT(HasMaterial(index));
