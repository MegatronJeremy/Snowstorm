...
#include "Snowstorm/Animation/Animation.h"
#include "Snowstorm/Animation/Skeleton.h"

#include "Snowstorm/Asset/Asset.h"

#include "Snowstorm/Core/Math/AABB.h"

#include "Snowstorm/Renderer/IndexBuffer.h"
#include "Snowstorm/Renderer/MaterialAsset.h"
#include "Snowstorm/Renderer/UniformBuffer.h"
#include "Snowstorm/Renderer/VertexBuffer.h"
...
namespace Snowstorm {
	...
	struct BoneInfluence
	{
		...
		void AddBoneData(uint32_t boneInfoIndex, float weight)
		{
			...
			{
				SS_CORE_WARN("Vertex bone weight is out of range. We will clamp it to [0, 1] (BoneID={0}, Weight={1})", boneInfoIndex, weight);
			...
			if (weight > 0.0f)
			{
				...
				SS_CORE_WARN("Vertex has more than four bones affecting it, extra bone influences will be discarded (BoneID={0}, Weight={1})", boneInfoIndex, weight);
			}
		}
	...
	public:
		...
		const Skeleton& GetSkeleton() const { SS_CORE_ASSERT(m_Skeleton, "Attempted to access null skeleton!"); return *m_Skeleton; }
