...
namespace Snowstorm
{
	...
	void Renderer2D::Flush()
	{
		...
		{
			uint32_t dataSize = static_cast<uint32_t>((uint8_t*)s_Data.QuadVertexBufferPtr - (uint8_t*)s_Data.
		...
		{
			uint32_t dataSize = static_cast<uint32_t>((uint8_t*)s_Data.CircleVertexBufferPtr - (uint8_t*)s_Data.
		...
		{
			uint32_t dataSize = static_cast<uint32_t>((uint8_t*)s_Data.LineVertexBufferPtr - (uint8_t*)s_Data.
		...
		{
			uint32_t dataSize = static_cast<uint32_t>((uint8_t*)s_Data.TextVertexBufferPtr - (uint8_t*)s_Data.
